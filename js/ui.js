...
const HELP_FAQS = [
  ...
  { keywords:{es:['promocion','marketing','redes sociales','promociones','descuento en promocion','codigo de descuento','2x1'],
      ca:['promocio','marketing','xarxes socials','promocions','descompte a promocio','codi de descompte'],
      en:['promotion','marketing','social media','promotions','discount in promotion','discount code']},
    answers:{
      es:'En <strong>Promoción</strong> puedes preparar contenido y campañas de marketing, y también crear promociones con <strong>efecto real en el TPV</strong>: marca "Aplica un descuento real", elige un plato/bebida y un %, y ese descuento se aplicará solo al pedirlo ese día. Puedes marcar "Se repite cada semana" para que no haga falta recrearla, y hay un contador de "veces canjeada" para saber si de verdad tuvo tirón.',
      ca:'A <strong>Promoció</strong> pots preparar contingut i campanyes de màrqueting, i també crear promocions amb <strong>efecte real al TPV</strong>: marca "Aplica un descompte real", tria un plat/beguda i un %, i aquest descompte s\'aplicarà sol en demanar-lo aquell dia. Pots marcar "Es repeteix cada setmana" perquè no calgui recrear-la, i hi ha un comptador de "vegades bescanviada" per saber si de veritat va tenir èxit.',
      en:'In <strong>Promotion</strong> you can prepare marketing content and campaigns, and also create promotions with a <strong>real effect at the till</strong>: tick "Applies a real discount", pick a dish/drink and a %, and that discount is applied automatically when it\'s ordered that day. You can tick "Repeats every week" so you don\'t have to recreate it, and there\'s a "redeemed" counter to know if it actually worked.' } },

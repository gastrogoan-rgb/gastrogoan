...
const HELP_FAQS = [
  ...
  { keywords:{es:['promocion','marketing','redes sociales','promociones','descuento en promocion'],
    ...
    answers:{
      es:'En <strong>Promoción</strong> puedes preparar contenido y campañas de marketing, y también crear promociones con <strong>efecto real en el TPV</strong>: marca "Aplica un descuento real", elige un plato/bebida y un %, y ese descuento se aplicará solo al pedirlo ese día (durante todo el día, no por franja horaria). Puedes marcar "Se repite cada semana" para que no haga falta recrearla. Si dos promociones con descuento coinciden en el mismo plato y fecha, la app avisa al guardar para que no compitan sin que te enteres.',
      ca:'A <strong>Promoció</strong> pots preparar contingut i campanyes de màrqueting, i també crear promocions amb <strong>efecte real al TPV</strong>: marca "Aplica un descompte real", tria un plat/beguda i un %, i aquest descompte s\'aplicarà sol en demanar-lo aquell dia (tot el dia, no per franja horària). Pots marcar "Es repeteix cada setmana" perquè no calgui recrear-la. Si dues promocions amb descompte coincideixen en el mateix plat i data, l\'app avisa en desar perquè no competeixin sense que te n\'adonis.',

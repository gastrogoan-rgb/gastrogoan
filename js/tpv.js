...
function renderTPV(){
  ...
  box.innerHTML = `
    ...
    <div class="toolbar">
      ...
      <button class="btn" onclick="openBankReconciliationModal()"><i class="ti ti-building-bank"></i> ${t('reconcile.btn')}</button>

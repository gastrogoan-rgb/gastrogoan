...
const PLAN360_DOCS_TEMPLATE = [
  {id: 'identidad', title: 'Libro de marca', categoria: 'Marca'},
  {id: 'playbook-sala', title: 'Playbook de sala', categoria: 'Sala', subtitulo: 'La guía para que cualquiera del equipo dé el mismo servicio, siempre.', seed:
`## Tono y promesa de servicio
Define cuál es el tono del servicio y cómo va a funcionar.
> "Cálido, experto y sin pretensiones: acogemos con cercanía, guiamos con conocimiento y resolvemos rápido."
Regla de oro: hablar siempre en primera persona, voz baja, ritmo pausado; sonreír con la mirada; nunca explicar excesos.
✎ El tono y la promesa de NUESTRO servicio:

## Sello identificativo
Define qué cosas son el sello del servicio (corte de jamón, postres, cócteles…) y el tipo de servicio: atento, exclusivo, rápido…
✎ Nuestro sello identificativo:

## Storytelling
Define cómo se cuenta la historia del negocio y de los platos, y cómo se conecta con el cliente.
✎ Nuestro storytelling:

## Secuencia de servicio — Reservas
Voz sonriente, hablar despacio y claro, libro de reservas a mano, evitar ruido de fondo. Nunca decir "no hay sitio": siempre ofrecer alternativas. Regla: repetir siempre la reserva antes de colgar.
> "Buenas tardes, restaurante ___, le atiende ___. ¿En qué puedo ayudarle?"
> "Perfecto, ¿para qué día y hora sería la reserva? ¿Para cuántas personas?"
> "A esa hora estamos completos, pero puedo ofrecerle ___ o ___."
> "Confirmo: día ___ a las ___, ___ personas, a nombre de ___. Le esperamos con mucho gusto."

## 1. Bienvenida
Breve, institucional, deja claro el estilo y genera expectativa sin detalles operativos.
> "Bienvenidos a [Nombre]; es un placer recibirles esta tarde/noche."
> "Gracias por elegirnos; vamos a cuidarle durante toda su visita."

## 2. Presentación y acompañamiento a la mesa
Sutil, guía al cliente, sugiere con elegancia una sola recomendación y entrega las cartas.
> "Si me permiten, les acompaño; hoy destacamos [plato] como entrada para compartir."
> "Les llevo a su mesa; cuando estén cómodos, les propongo una copa de bienvenida."

## 3. Toma de comanda
Preguntas precisas y cortas; confirmar alérgenos con respeto; repetir la comanda como servicio.
> "Antes de anotar, ¿alguna intolerancia o preferencia que deba conocer?"
> "Apunto: una copa de X y una de Y. Repito para confirmar, ¿correcto?"

## 4. Servicio de entrantes
Nombrar plato, un atributo y un consejo de consumo en una línea.
> "Aquí tienen el [plato]; lleva [ingrediente], disfrútenlo en primer término para apreciar su textura."

## 5. Principales y control del tiempo
Anunciar con discreción, coordinar tiempos y ofrecer ajuste sin ser intrusivo.
> "Les traigo el principal; hemos cuidado el punto según su preferencia."

## 6. Durante el servicio
Aparecer con naturalidad, preguntar por una mejora concreta y anticipar la siguiente acción.
> "¿Todo correcto con su plato?"
> "¿Cómo va todo hasta ahora?"

## 7. Postres y café
Sugerir uno y un acompañamiento, con lenguaje evocador y opción de compartir.
> "Para terminar, le propongo nuestro postre X; es perfecto para compartir."

## 8. Cuenta y despedida empática
Entregar la cuenta con calidez, agradecer y ofrecer una razón concreta para volver.
> "Aquí tiene la cuenta; muchas gracias por elegirnos, ha sido un placer atenderles."
...
- ¿Qué tipo de cocina hacemos? ¿Qué nos diferencia del resto?
- ¿Qué emociones queremos transmitir? ¿Qué NO somos?
- ¿Qué productos representan nuestra zona o estilo?
Sin identidad clara, no hay plato propio.

## 2. Elegir el producto protagonista
Todo plato nace de un ingrediente principal, no de una mezcla aleatoria. Criterios: de temporada, local o representativo, que el cliente reconoce, rentable y que encaja con la identidad.
Un plato sin protagonista es un plato sin alma.

## 3. Definir técnica y estilo
Decide cómo tratar el producto: brasa, plancha, confitado, salteado, horno, crujiente, marinado, fermentado… Pregúntate qué técnica representa tu estilo, cuál domina el equipo, cuál respeta el producto y cuál es viable en servicio.
La técnica debe reforzar la identidad, no complicar la operativa.

## 4. Construir el plato — 4 capas
Todo plato profesional se construye por capas con propósito.
- 1 · Intención y función: qué debe lograr el plato (emoción, rol en la carta, cliente objetivo). Todas las decisiones posteriores responden a esta intención.
- 2 · Arquitectura: base (unión y profundidad) + protagonista (con su técnica) + 1-2 acompañamientos + elemento de contraste (ácido, amargo, crujiente) + toque final. Regla: 1 protagonista + 2 apoyos + 1 sorpresa.
- 3 · Balance de sabores: sal (realza, al final), ácido (limpieza y ligereza), grasa (redondez), dulce (equilibra), amargo/umami (profundidad). Cada bocado, al menos dos de estas notas.
- 4 · Texturas, temperaturas y colores: mínimo 3 texturas (cremoso, tierno, crujiente), una temperatura dominante y un contraste, mínimo 3 tonos de color.
Operativa real: montaje ≤ 3 min por plato, controla los puntos críticos (temperatura, reposo, crujiente), define el mise en place y calcula el escandallo (coste por ración y margen objetivo).

## 5. Presentación y narrativa
Foco visual en el protagonista, lectura natural desde el frente del comensal, porción adecuada al ticket, y un nombre breve, evocador y honesto con un guiño de identidad.

## 6. Asegurar identidad y diferenciación
El plato debe tener algo propio del local: un aliño característico, una salsa de la casa, un toque de brasa, un ingrediente local, una presentación reconocible o un contraste inesperado pero coherente.
Ese «toque propio» es lo que hace que el plato sea tuyo.

## 7. Validar rentabilidad y operativa
- ¿Tiene escandallo rentable?
- ¿Se puede reproducir igual cada día?
- ¿Se puede montar en menos de 3 minutos?
- ¿Los ingredientes son fáciles de conseguir?
- ¿Encaja con el resto de la carta?
Un plato espectacular que no se puede ejecutar no sirve.

## 8. Testeo y ajustes
- Validación interna: equipo de cocina + encargado.
...
- Comunicar con propósito: cada comunicación con objetivo claro, receptor definido y acción esperada.
- Decidir y responsabilizar: decisiones rápidas en servicio; responsabilidades claras y escalado definido.
- Aprender y mejorar: los errores como aprendizaje; mejoras bienvenidas y registradas.
- Reconocer y visibilizar: reconocimiento frecuente y público de lo alineado con la cultura.

## Briefing de inicio de turno (2-3 min)
Estructura: prioridad del día · roles y responsables · riesgos · objetivo medible.
> "Hoy priorizamos [X]. Responsable de pase: [A]. Riesgo: [Z]. Objetivo: mantener tiempos y cero incidencias."

## Micro-feedback en servicio (30-60 s)
1 cosa bien + 1 mejora inmediata. Corregir en el momento; reforzar después.

## 1:1 semanal con cada persona (10-15 min)
Agenda: estado, logro, bloqueo, objetivo semanal, apoyo requerido. Registro: 1 línea con acción y fecha de revisión.

## Ritual de reconocimiento
Mencionar 1 logro en cada briefing semanal y documentarlo. Recompensas simples: turno preferente, mención en grupo, incentivo operativo.

## Delegación clara
Plantilla: tarea · resultado esperado · tiempo · recursos · señal de bloqueo. Delegar siempre con confirmación verbal.

## Cultura
✎ Compromiso del equipo (la frase que nos define):
Valores clave (ejemplo):
- Respeto: tratamos a clientes y compañeros con cortesía.
- Responsabilidad: cumplimos horarios y tareas sin excusas.
- Calidad: cuidamos cada plato y servicio.
- Proactividad: proponemos mejoras y ayudamos sin esperar orden.
- Seguridad: priorizamos higiene y seguridad siempre.`},
  {id: 'proceso-seleccion', title: 'Proceso de selección de personal', categoria: 'Personal', subtitulo: 'De la publicación a la contratación, con textos listos para usar.', seed:
`## 1. Publicación y recepción de candidaturas
- Escoge las plataformas (JobToday, LinkedIn, InfoJobs…).
- Publica un anuncio claro y breve: puesto, responsabilidades, turno/jornada, salario orientativo.
- Indica cómo aplicar: CV + formulario corto (nombre, teléfono, disponibilidad, turno preferente).
- Recoge los CVs en una lista con: nombre, teléfono, disponibilidad, experiencia clave y fecha. Ordénala por preferencia.

## 2. Criba general de candidatos
- Revisa CV + formulario en bloques (cada 10-15 candidatos).
- Saca una lista de los 5 mejores perfiles para convocar a entrevista.
- A los que no encajan, mensaje cordial y guardar en el banco de candidatos.

## 3. Validación inicial
Confirmar disponibilidad y convocar a entrevista por WhatsApp o llamada.
> "Hola [Nombre], soy [Tu nombre] de [Restaurante]. Te convocamos a una entrevista presencial el [día] a las [hora] en [dirección]. ¿Puedes confirmar asistencia? Gracias."

## 4. Entrevista presencial (20-25 min)
Profundizar en experiencia, motivación y comportamientos, y comprobar coherencia. Puntuar sobre 30. Guion paso a paso:

### 1 · Bienvenida e introducción
> "Hola, soy [Nombre], responsable de [área]. Gracias por venir. La entrevista durará 20-25 minutos: revisaremos tu experiencia, haremos tres preguntas de situaciones reales y algunas técnicas. ¿Te viene bien?"
Observar: puntualidad, saludo, lenguaje corporal. Registrar: llegó puntual (S/N), primera impresión.

### 2 · Presentación del local
> "Trabajo aquí como [puesto] desde [tiempo]. Somos un restaurante de [estilo], con [nº] servicios diarios y un equipo de [nº]. Nuestro pico es [horario] y buscamos cubrir [turnos/funciones]."

### 3 · Explicar el objetivo de la entrevista
> "El objetivo es comprobar tu experiencia y ver cómo resuelves situaciones reales. Si avanzas, habrá una prueba práctica presencial. ¿De acuerdo?"

### 4 · Repaso del CV y datos críticos
> "Veo que trabajaste en [Empresa]. ¿Qué rol exacto tenías y en qué fechas?"
> "¿Qué tareas hacías a diario? ¿Qué turnos realizabas?"
> "En tu CV aparece [puesto]; dime 3 tareas que hacías cada servicio."
Objetivo: verificar veracidad y responsabilidad real; detectar huecos o inflados.

### 5 · Confirmar experiencia relevante
> "Para resumir: ¿podrías en 1-2 frases describir tu experiencia más relevante para este puesto y cuándo podrías incorporarte?"

### 6 · Verificar disponibilidad y condiciones
> "¿Cuál sería tu fecha de incorporación? ¿Qué turnos puedes cubrir? ¿Alguna restricción horaria? ¿Cuál es tu expectativa salarial bruta mensual?"

### 7 · Preguntas conductuales (situación · acción · resultado)
> "Cuéntame una vez que hubo un fallo en servicio (plato equivocado, retraso, falta de producto). ¿Qué hiciste y cuál fue el resultado?"
> "Dame un ejemplo de cuando el equipo se saturó en servicio y cómo ayudaste a mantener el ritmo."
> "Cuéntame un feedback difícil que recibiste y qué cambiaste tras ello."
Puntuar cada una: concreción (1-5), acción/responsabilidad (1-5), resultado/aprendizaje (1-5).

### 8 · Preguntas técnicas
> "En plena salida falta un ingrediente base; ¿qué haces en los próximos 5 minutos?"
> "Fallo del lavavajillas en pico: ¿cómo garantizas copas y servicio?"

### 9 · Casos del puesto (respuesta en una frase)
> "Una mesa lleva 20 minutos desde la comanda; ¿qué haces inmediatamente?"
> "Tienes que reponer cristalería para 50 covers en 15 minutos y el lavavajillas está a tope; ¿qué priorizas?"

### 10 · Cierre y siguientes pasos
> "¿Puedes traer DNI y referencias a la prueba práctica si te convocamos?"
> "Te confirmaremos por WhatsApp o llamada en 48-72 horas. Gracias por tu tiempo."

### Plantilla final de evaluación
| Campo | Valoración
| Nombre / puesto / fecha / entrevistador |
| Llegada puntual (S/N) · Presentación (0-5) |
| CV coherencia (0-5) · Expectativa salarial (0-5) |
| Experiencia (0-5) · Técnica (0-5) · Actitud (0-5) |
| Disponibilidad (inmediata / 15 / 30) |
| TOTAL / 30 · Decisión |

## 5. Prueba práctica (15-45 min)
Observar ejecución real. Máximo 3 acciones, de una en una (ej.: limpiar 2 salmones, pulir 20 copas, simular pase de 3 mesas).
Puntuar (1-5): puntualidad, técnica, limpieza/orden, ritmo, resultado, comunicación. Total /30.
Dar 2 minutos de feedback al terminar e informar del plazo de decisión.

## 6. Decisión y comunicación
Sumar entrevista + prueba sobre 60.
- 45-60: perfil positivo para contratar.
...
| Ítem | Puntuación (1-3)
| Puntualidad y asistencia (llega 10 min antes; avisa con 24 h) |
| Cumplimiento operativo (checklists HACCP, cierre) |
| Calidad técnica (consistencia en recetas / servicio) |
| Comunicación (clara, propone soluciones) |
| Trabajo en equipo (apoya en picos, colabora) |
| Actitud y profesionalidad (trato, higiene, respeto) |
| Feeling general (soltura, comodidad) |
| TOTAL / 21 |

## Reconocimiento
Cuándo reconocer: en el momento (resolución de una queja, salvar un servicio, iniciativa que evita desperdicio), al cierre del turno (micro-reconocimiento, 30 s), semanalmente (mención en el briefing con evidencia), trimestralmente (premio operativo: bono, día libre, formación).
> "Gracias, [nombre], por resolver la queja en 3 min; el cliente se fue satisfecho."
> "Reconocimiento: [nombre] por [acción] — impacto: [resultado]."
Combinar reconocimiento social y tangible (comida, turno preferente, certificado) es más efectivo que solo uno.

## Compensación
Criterios para considerar una recompensa: impacto medible (redujo tiempos, evitó una queja, ahorró coste), iniciativa y solución sin esperar instrucciones, consistencia durante X turnos (7-30 días), comportamiento cultural (colaboración, seguridad, proactividad).
Tipos de compensación, de menor a mayor:
- Reconocimiento verbal inmediato: refuerzo instantáneo.
- Mención pública en briefing: visibilidad y orgullo.
- Micro-beneficio: comida, bebida o turno preferente.
- Micro-bono (5-20€): por acción excepcional o ahorro medible.
- Bono mensual/trimestral: por rendimiento sostenido.
- Desarrollo: formación pagada o rotación a puesto de interés.
- Día libre o compensación de horas: por esfuerzo extraordinario.

## Retención — 10 acciones prácticas
- Pago anticipado de parte del salario ya ganado.
- Participación en un % mensual del beneficio si se alcanzan metas.
- Bolsa de horas flexibles canjeable por días libres o pago.
- Microformación certificable.
- Días extra pagados por antigüedad (2 cada 6 meses).
- Uniforme gratuito y reposición anual.
- Una comida completa del personal.
- Día de descanso flexible.
- Convenio con gimnasio o salud.
- Lotes de producto de calidad por buen desempeño.`},
  {id: 'onboarding-seguimiento', title: 'Onboarding y seguimiento', categoria: 'Personal', subtitulo: 'Cómo recibir a una nueva persona y acompañarla sus primeros 90 días.', seed:
`## Mensaje de onboarding
Plantilla de bienvenida para entregar al nuevo miembro. Personaliza los campos entre paréntesis.
> "Bienvenid@ al equipo de (nombre del negocio). Desde hoy formas parte de un proyecto que va más allá de lo comercial: aquí creemos en (propósito o filosofía). Cada persona que se une aporta algo único, y tú no eres la excepción. Este documento te ayudará a entender quiénes somos, qué valoramos y qué esperamos de ti."
✎ Nuestros valores (3, con breve descripción):
✎ Tu rol: puesto, área, supervisor/a y principales responsabilidades:
Primeros pasos: conocerás al equipo y el espacio, recibirás formación de procesos internos, tendrás apoyo para dudas y un/a referente que te acompañe.
> Cierre: "Gracias por elegir formar parte de (nombre del negocio). Tu energía, talento y actitud serán clave. ¡Bienvenido/a oficialmente!"

## Checklist previo al primer día — Documentación
- Contrato firmado y copia archivada (RRHH).
- DNI / permiso de trabajo y copias (RRHH).
- Certificados obligatorios verificados: HACCP, manipulador (RRHH).

## Checklist previo al primer día — Comunicación al nuevo empleado
- Email/WhatsApp de bienvenida con fecha, hora y punto de encuentro (Encargado).
- Plan de incorporación enviado: horarios, persona de referencia, checklist (Encargado).
- Contacto de emergencias y normas básicas compartidas (Encargado).

## Checklist previo al primer día — Puesto, accesos y material
- Uniforme y EPI asignado y etiquetado.
- Puesto preparado: estación, cuchillería, ficha técnica, foto de montaje.
- Accesos: taquilla, fichaje, grupo de equipo.
- Sesión de seguridad e higiene programada para el primer día.
- Ficha del puesto y plan de 7 días impresos.

## Plan de seguimiento por hitos
| Hito | Qué verificar · resultado esperado
| Día 15 | Integrado y seguro: puntualidad, ejecuta tareas esenciales con supervisión, usa EPI y HACCP, participa en briefing.
| Día 30 | Operativo con supervisión mínima: 80% de tareas autónomo, calidad en estándar, mantiene ritmo, aplica feedback.
| Día 60 | Consolidado y eficiente: autonomía 90%, calidad consistente, minimiza mermas, ayuda al equipo.
| Día 90 | Desempeño pleno: cumple estándares, actitud alineada, puede formar a otros. Decisión de continuidad.
> Script del responsable (día 15): "Repaso rápido: ¿cómo te has sentido? Hoy revisamos 5 puntos; dime si algo bloquea tu trabajo. Luego acordamos 1 acción concreta si hace falta."

## Comportamientos clave
- Puntualidad activa: llegar 10 min antes, preparado y con uniforme; avisar con 24 h si no se puede asistir.
- Proactividad resolutiva: si detectas un problema, propones y ejecutas o escalas con propuesta.
- Respeto operativo: tono profesional, conflictos en privado, espacio ordenado.
- Responsabilidad con recursos: anotar mermas, rotar stock y minimizar desperdicios.`},
  {id: 'estrategia-editorial', title: 'Estrategia editorial mensual', categoria: 'Marketing', subtitulo: 'Un sistema sencillo para organizar un mes de contenido, publicidad y reputación. Constancia > perfección.', seed:
`## Cómo se usa (4 pasos, una vez al mes)
- Elige el foco del mes: una idea que lo ordene todo (un plato de temporada, una fecha señalada, una promo o un objetivo).
- Reparte los 5 pilares en la semana tipo.
- Rellena la parrilla mensual con las publicaciones y acciones concretas.
- Revisa cada semana qué funcionó (guardados, mensajes, reservas) y ajusta.

## Los 5 pilares
- Producto — el plato que da hambre. Foto o vídeo del que más vende. Tu contenido estrella.
- Personas — equipo y cocina, backstage, el género fresco. Genera cercanía y confianza.
- Prueba social — reseñas, clientes disfrutando, el local lleno. Convence más que tú hablando de ti.
- Promo — nuevo plato, menú del día, evento, reserva. La llamada a la acción clara.
- Valor — un tip, el origen de un producto, la historia del local. Te posiciona como referente.

## Ritmo semanal — qué publicar cada día
| Día | Pilar | Qué publicar
...
## Acciones del mes
- Pedir 10 reseñas nuevas en Google.
- Responder TODAS las reseñas.
- Actualizar fotos de Google/Maps.
- Tener 1 campaña de Meta Ads activa.

## Reputación: las reseñas venden mientras duermes
Pídelas en el mejor momento: al cliente contento, justo al pagar. Un QR en mesa o ticket que lleve directo a reseña.
> "¿Nos ayudas con una reseña? Te lleva 20 segundos" — y el QR. Sin fricción.
Responde SIEMPRE: a las buenas, gracias y cercanía; a las malas, sin pelear: reconoce, disculpa e invita a arreglarlo en privado.

## Publicidad del mes — si inviertes, con foco
Objetivo: llenar días flojos, anunciando a 3-5 km a tu cliente local. Presupuesto: 5-10 €/día (diario, no total). Empieza pequeño y sube lo que funcione. Creatividad: tu mejor reel del plato estrella + llamada clara: "Reserva".

## Métricas — los números que miras cada semana
- Alcance y guardados (qué post gustó más).
- Mensajes directos y seguidores nuevos.
- Reseñas nuevas y nota media.
- Reservas y clics que llegan por redes.
Recuerda: la única pregunta que importa es ¿esto me trae clientes? Dobla lo que funciona, corta lo que no.

## Banco de 30 ideas — nunca sin ideas
Producto: plato estrella en reel · salsa cayendo a cámara lenta · el corte / primer bocado · bebida o cóctel de la casa · postre montándose · plato nuevo de temporada.
Personas y cocina: el género fresco que llega · un día con el chef · cómo se elabora un plato · el café de la mañana · presenta a un miembro del equipo · montaje de sala antes de abrir.
Prueba social: repost de un cliente · captura de una reseña 5★ · el local lleno un sábado · testimonio en vídeo · "gracias por otro finde lleno" · cliente habitual y su plato favorito.
Promo y valor: menú del día en Story · reserva para el puente · evento o cena especial · encuesta ("¿carne o pescado?") · el origen de un producto local · un consejo de cocina en casa.
Consejo final: graba en lote — un día a la semana, 30 minutos, para tener 4-5 vídeos o fotos listos.`},
  {id: 'guia-meta-ads', title: 'Guía de Meta Ads', categoria: 'Marketing', subtitulo: 'Cómo conseguir clientes con anuncios en Instagram y Facebook, paso a paso, sin perder dinero.', seed:
`Pensado para un restaurante o bar de barrio, no para un experto en marketing. Lee primero "antes de gastar un euro": te ahorrará el error que comete casi todo el mundo.

## Antes de gastar un euro
Meta Ads es la herramienta para anunciarte en Instagram y Facebook. Bien usada, llena tus mesas flojas con clientes de tu zona. Mal usada, es tirar dinero.
El error nº1 que comete todo el mundo: darle al botón azul de «Promocionar publicación» en Instagram. Es cómodo, pero gastas más y segmentas peor. Siempre se crea desde el Administrador de Anuncios. Esa diferencia sola ya te ahorra dinero.
- Idea 1 — El anuncio lleva a tu perfil: antes de anunciarte, tu Instagram tiene que estar cuidado (buenas fotos, bio clara, cómo reservar). Si el perfil da pena, el cliente no viene.
- Idea 2 — Amplifica, no salva: la publicidad multiplica un buen negocio; no arregla uno malo.
- Idea 3 — Local, no el mundo: anúnciate solo a 3-5 km a la redonda.
- Idea 4 — Valor, no descuento: el que viene solo por un 50% no vuelve a pagar precio completo.
Lo que necesitas tener listo: una página de Facebook del negocio, tu Instagram vinculado a ella, una cuenta en Meta Business Suite (business.facebook.com) y un método de pago. Se crean gratis en 10 minutos.

## Crear tu campaña, paso a paso
- 1. Entra en el Administrador de Anuncios — business.facebook.com → Administrador de Anuncios → botón verde «Crear». Nunca desde el botón azul de la app.
- 2. Elige el objetivo — «Interacción» (mensajes a tu WhatsApp/Instagram) o «Tráfico» (llevar a tu web de reservas). Si dudas, empieza por interacción.
- 3. Define el presupuesto — empieza con 5-10 € al día, diario no total.
- 4. Segmenta tu público — ubicación: tu local + 3-5 km; edad y sexo: tu cliente ideal; intereses: gastronomía, restaurantes, planes locales.
- 5. Sube la creatividad — vídeo corto (10-20 s) que dé hambre o una foto muy buena del plato estrella, con un gancho y una llamada clara: «Reserva», «Te esperamos», «Pídelo».
- 6. Publica y espera — Meta lo revisa en unas horas. Déjalo correr 3-4 días sin tocarlo.
Truco: crea 2-3 versiones del anuncio (distinta foto o texto) con poco presupuesto cada una; a los pocos días, apaga las que no funcionan y pon el dinero en la ganadora.`},
  {id: 'guia-fotografica', title: 'Guía fotográfica', categoria: 'Marketing', subtitulo: 'Fotos que dan hambre, con el móvil que ya tienes.', seed:
`La foto no corrige errores: el plato sale de cocina impecable y solo entonces disparas.

## 1. Preparación previa
- Superficie y fondo neutro: madera, mármol o tela lisa; máximo 2 props coherentes.
- Luz natural lateral: junto a una ventana; evita luz directa y sombras duras.
- Organiza el flujo: ten a mano el plato, el móvil, un reflector improvisado (cartón blanco) y un paño.

## 2. Ajustes técnicos
- Activa la cuadrícula para componer con la regla de tercios.
- Dispara en RAW si tu móvil lo permite; si no, en la máxima calidad JPG.
- Bloqueo de exposición y enfoque (AE/AF Lock): toca el punto y mantén para fijar.
- HDR para platos con alto rango dinámico; prueba ON/OFF. Limpia la lente antes de cada sesión.

## 3. Iluminación
- Luz lateral suave: coloca el plato perpendicular a la ventana.
- Reflector casero: cartón blanco para rellenar sombras desde el lado opuesto.
- Evita el flash del móvil; si necesitas más luz, usa una LED continua con difusor, lateral.
- Hora ideal: luz de día, mañana o tarde con cielo ligeramente nublado.

## 4. Composición y ángulos
- 90° cenital: bowls, mesas con varios elementos o platos planos.
- 45° tres cuartos: platos con volumen y contexto de mesa.
- 10-20° bajo: carnes y platos con altura.
Regla práctica: 3 ángulos por plato (cenital, 45° y detalle cercano) y deja espacio negativo para textos o recortes.

## 5. Estilismo y detalles finales
- Último toque en el momento: hierba fresca, crujiente o gotas de aceite.
- Controla brillos: un paño mate para eliminar reflejos indeseados.
- Color: añade un elemento verde o ácido para contraste cromático.
- Acción: una toma con salsa vertiéndose o una mano aporta storytelling.

## 6. Paso a paso
Monta el plato y da el toque final → apoya el móvil estable (trípode pequeño) → ajusta encuadre y bloquea exposición/enfoque → dispara ráfaga de 5-8 fotos variando ángulo → revisa en pantalla y repite si hace falta → etiqueta la mejor con nombre y versión.

## 7. Edición rápida
Apps: Lightroom Mobile o Snapseed. Ajustes: exposición, contraste, temperatura, sombras y claridad; saturación selectiva sin exagerar. Recorte: 4:3 o 3:2 para web, 1:1 para Instagram. Exportar: JPG sRGB, lado largo 1200-1600 px, calidad 80-90%.`},
  {id: 'gestion-google-maps', title: 'Gestión del perfil de Google', categoria: 'Marketing', subtitulo: 'Cómo tener un perfil que atrae clientes y cómo responder reseñas. Plan a 3 meses.', seed:
`## Mejoras del perfil
✎ Mejoras que necesita el perfil de Google de este negocio:

## Información básica
- Horario actualizado (incluye festivos y cierres).
- Teléfono correcto y operativo.
- Dirección exacta + pin bien colocado.
- Web y enlace de reservas funcionando.
- Categoría principal correcta + secundarias relevantes.

## Fotos y vídeos (mínimo 5 nuevas al mes)
- Fotos de platos actuales, local, equipo y ambiente.
- Vídeos cortos (10-20 s).
- Eliminar fotos antiguas o de baja calidad.
- Subir fotos verticales (Google las prioriza).

## Servicios, atributos y menú
- Servicios: terraza, delivery, take away, menú del día, accesibilidad, pago con tarjeta.
- Atributos: apto para familias, pet friendly, veg-friendly, sin gluten.
- Menú actualizado con platos estrella destacados, precios y fotos reales.
- Quitar platos que ya no existen.

## Reseñas
- Responder al 100% de reseñas (máx. 24 h).
- Solicitar reseñas a clientes satisfechos.
- Detectar patrones (platos, servicio, tiempos).

## Mantenimiento
Diario: leer reseñas nuevas, responder con tono profesional, marcar las que requieren acción interna.
Semanal: subir 5 fotos, publicar 1-2 posts, revisar menú, precios, horarios y atributos.
Mensual: auditar categorías, fotos antiguas, coherencia del menú y estadísticas (visitas, llamadas, clics).

## Protocolo de respuestas a reseñas
| Tipo | Tiempo máx. | Cómo responder
| Positiva | 24 h | Agradecer y mencionar el detalle; invitar a volver.
| Neutra (3★) | 12 h | Agradecer, tomar nota para mejorar, invitar de nuevo.
| Negativa (1-2★) | 6 h | Lamentar sin excusas, indicar revisión interna, ofrecer contacto.
| Falsa / injusta | — | Cordial, indicar que no hay registro pero se quiere ayudar; reportar a Google.
Tono siempre: cercano pero profesional, agradecido, sin excusas, sin confrontación, ofreciendo solución y cerrando con invitación a volver.

## Plantillas listas para copiar
> Positiva: "¡Gracias, [Nombre]! Nos alegra que hayas disfrutado de [detalle]. Te esperamos pronto para seguir sorprendiéndote."
> Neutra: "Gracias por tu comentario, [Nombre]. Tomamos nota de lo que mencionas para mejorar. Nos encantará verte de nuevo."
...
- Busca un lugar con buena luz y poco ruido.
- Graba en vertical (Reels, TikTok, Shorts).
- Móvil a la altura de los ojos.
- Pide permiso para usar el vídeo en redes y web.
- Explica que será rápido y sencillo (1 minuto).

## Estructura del testimonio
El testimonio debe seguir esta estructura — genera más confianza que un "todo muy rico":
- Quién soy.
- Qué buscaba / qué problema tenía.
- Qué encontré en el restaurante.
- Qué me sorprendió / qué me encantó.
- Por qué volvería / por qué lo recomiendo.
- Resumen final en una frase.

## Guion de entrevista (preguntas exactas)
Haz 3-5 preguntas, no más. El cliente debe hablar en frases cortas y naturales.
> "¿Cómo te llamas y qué te trajo hoy al restaurante?"
> "¿Qué estabas buscando o qué esperabas encontrar?"
> "¿Qué es lo que más te ha gustado de la comida o del ambiente?"
> "¿Qué dirías que nos hace diferentes a otros sitios de la zona?"
> "Si tuvieras que recomendarlo a un amigo, ¿qué le dirías?"
> "Resume tu experiencia en una frase corta y contundente."

## Checklist de calidad del testimonio
- Cliente cómodo y sonriente.
- Audio claro.
- Vídeo vertical.
- Duración 20-40 segundos.
- Menciona al menos 1 beneficio (comida, servicio, ambiente).
- Menciona por qué volvería.
- Fondo limpio y luz frontal.

## Dónde usar estos testimonios
- Reels / TikTok.
- Stories destacadas.
- Google Maps (subir como vídeo).
...
`Asigna un responsable a cada etapa del proceso. Lo que no tiene dueño, no se hace.

## Revisión diaria
- 1. Gestión inicial — alinear objetivos del día y resolver incidencias (proveedores, personal, pagos, clientes).
- 2. Gestión de personal — confirmar turnos, resolver incidencias de última hora y asignar sustituciones.
- 3. Repaso de reservas / ocupación — ajustar personal, prever picos y definir prioridades de servicio.
- 4. Gestión del servicio y satisfacción — detectar desviaciones operativas y resolver incidencias en tiempo real.
- 5. Cierre administrativo del día — revisar KPIs (food cost, ticket medio, ocupación, satisfacción), cerrar caja, pasar tiquets y facturas.
✎ Responsable de cada etapa diaria:

## Revisión mensual
- 1. Cierre contable mensual — consolidar ventas, costes directos e indirectos y preparar el informe de resultados del mes.
- 2. Revisión de cashflow y previsión — proyección de liquidez para 30/60 días y detección de picos de pago.
- 3. Gestión de nóminas — validar la nómina mensual, horas extras y variaciones de plantilla antes de pagar.
- 4. Gestión fiscal — preparar impuestos mensuales/trimestrales (retenciones, IVA, modelos) y coordinar con asesoría.
- 5. Inventario completo — conteo detallado de almacén para actualizar stocks.
- 6. Actualización de escandallos y precios — actualizar costes por plato frente a variaciones de producto y revisar márgenes.
- 7. Evaluación de proveedores — analizar precios, plazos y calidad; renegociar condiciones si procede.
- 8. Mantenimiento preventivo — revisar partes y coordinar intervenciones técnicas programadas.
- 9. Formación y evaluación del personal — planificar microformaciones y evaluar el desempeño del mes.
- 10. Marketing y ventas — revisar campañas, reservas, eventos y ROI de las acciones promocionales.
- 11. Revisión de KPIs del mes — ticket medio, covers, ocupación, food cost y % margen por categoría.
- 12. Planificación del mes que entra — ajustar pedidos según rotación y previsión de demanda.
- 13. Resumen mensual y plan de acción — documento ejecutable con incidencias, responsables y objetivos para el mes siguiente.
...
// Mismo problema que mergeCartaStock, pero para el cupo diario de una
// promoción (DB.promos[].usedDates = {"2026-09-06": 3, ...}): registerPromoUse
// (js/app.js) incrementa el contador del día directamente dentro del
// documento de la promoción, que mergeArraysById fusiona entero. Dos
// camareros aplicando la misma promo casi a la vez podían perder uno de los
// dos usos al sincronizar, permitiendo saltarse el cupo máximo diario sin
// que nadie lo notara. Hallazgo de una auditoría externa.
function mergePromosUsedDates(localPromos, mergedPromos, lastSyncedPromosJson){
  ...
  mergedPromos.forEach(p => {
    ...
    const baseUD = (base && base.usedDates) || {};
    const localUD = local.usedDates || {};
    const remoteUD = p.usedDates || {};
    const dias = new Set([...Object.keys(baseUD), ...Object.keys(localUD), ...Object.keys(remoteUD)]);
    const fusion = {};
    dias.forEach(d => {
      const b = baseUD[d] || 0;
      // Suma de los DOS usos añadidos desde el último punto en común, no
      // "gana el último que llegue" — igual que con el stock de cartas/menús.
      const deltaLocal = (localUD[d]||0) - b;
      const deltaRemote = (remoteUD[d]||0) - b;
      const v = b + deltaLocal + deltaRemote;
      if(v > 0) fusion[d] = v;
    });
    p.usedDates = fusion;
  });
...
// Mismo problema que mergeElaboracionesStock, para los dos contadores de
// DB.clients (points: fidelidad, noShows: reservas no presentadas).
// registerClientVisit y markReservationNoShow (js/app.js) los incrementan
// directamente dentro del documento del cliente, que mergeArraysById fusiona
// entero. Confirmar la llegada de un cliente en dos dispositivos casi a la
// vez (p.ej. dos reservas suyas el mismo día) podía perder uno de los dos
// puntos o avisos al sincronizar. Hallazgo de una auditoría externa.
function mergeClientCounters(localClients, mergedClients, lastSyncedClientsJson){
  ...
  ['points', 'noShows'].forEach(campo => {
    mergedClients.forEach(c => {
      if(!c || c.id == null || c[campo] == null) return;
      const local = localMap.get(c.id);
      if(!local || local[campo] == null) return;
      const base = baselineMap.get(c.id);
      const baseVal = (base && base[campo] != null) ? base[campo] : local[campo];
      const deltaLocal = local[campo] - baseVal;
      const deltaRemote = c[campo] - baseVal;
      let v = Math.max(0, baseVal + deltaLocal + deltaRemote);
      // `points` tiene un tope de 10 (registerClientVisit): si los dos lados
      // llegaron al tope por separado desde el mismo punto de partida, sumar
      // los dos deltas se pasaría de 10. El tope real lo sigue poniendo
      // registerClientVisit; aquí solo se respeta al fusionar.
      if(campo === 'points') v = Math.min(v, 10);
      c[campo] = v;
    });
  });
...
/* ============================================================
   DÓNDE VIVE EL ESPEJO PÚBLICO
   ============================================================
   El espejo público (lo que lee reservagastrogoan.html: la carta, el aforo,
   las reservas que entran) vivía en la Firebase COMPARTIDA de la plataforma.
   Funcionaba, pero no escala y el techo está mucho más bajo de lo que parece:
   el plan gratuito de Firebase permite 100 CONEXIONES SIMULTÁNEAS, y una
   conexión es una pestaña abierta. Con el espejo compartido, cada app de
   gestión abierta y cada cliente mirando la carta ocupaban una conexión de
   ESE MISMO proyecto. Cuentas: a partir de unos 50-100 negocios, la página
   de reservas empieza a fallar A LA VEZ para todos los clientes, un viernes
   por la noche, que es cuando más se usa.

   Ahora el espejo vive en la nube DE CADA NEGOCIO — que es donde estaba
   pensado desde el principio (sus reglas ya contemplaban el nodo `public`).
   Así las conexiones se reparten entre tantos proyectos como negocios haya,
   cada uno con su propio cupo gratuito, y a GastroGoan no le cuesta nada por
   muchas licencias que venda.

   Y no abre ninguna conexión nueva: la app de gestión YA está conectada a la
   nube del negocio (initCloud la registra como app por defecto), así que se
   reutiliza esa misma.
...
function getPublicMirrorApp(){
  ...
  if(cfg && cfg.apiKey && cfg.databaseURL){
    try{
      const app = firebase.app();   // la del negocio, ya autenticada
...
async function comprobarEspejoEnNubePropia(){
  ...
  try{
    ...
    // Sufijo por dispositivo, no un "_prueba" fijo: si dos aparatos del mismo
    // negocio arrancan a la vez, cada uno escribe/borra su propio nodo en vez
    // de pisar la sonda del otro (que hacía fallar la comprobación de uno de
    // los dos esa vez, sin motivo real — el negocio sí tenía las reglas bien).
    const sondaId = '_prueba_' + getOrCreateDeviceId();
    await base.child('aforoHold/' + sondaId + '/_prueba').set(0);
    await base.child('aforoHold/' + sondaId + '/_prueba').remove();
    ...
    await base.child('orderStatus/' + sondaId).set({status: '_prueba', updatedAt: Date.now()});
    await base.child('orderStatus/' + sondaId).remove();
    ...
    try{
      ...
      const sondaReqId = '_sonda_' + sondaId;
      const sonda = base.child('requests/' + sondaReqId);
...
/* La página pública solo conoce el `publicId` (va en el QR y en el enlace),
   y de ahí no se puede deducir a qué proyecto de Firebase conectarse: el
   publicId se deriva del tenantId con un hash de un solo sentido. Así que se
   publica esta guía mínima en la plataforma compartida: publicId → en qué
   nube está ese negocio.

   Se lee SIN autenticar y por REST a propósito (ver reservagastrogoan.html):
   una petición HTTP no abre socket, así que no consume ninguna de las 100
   conexiones simultáneas del plan gratuito. Y no expone nada: el apiKey y la
   databaseURL de Firebase no son secretos —viajan en el JavaScript de
   cualquier web que use Firebase— y lo que protege los datos son las reglas,
   no esconderlos. */
function publishPublicLookup(publicId, config){
  if(!publicId || !config || !config.apiKey || !config.databaseURL) return;
  getPlatformFirebaseApp().then(app => {
    if(!app) return;
    app.database().ref('gastrogoan/publicLookup/' + publicId).set({
      apiKey: config.apiKey, databaseURL: config.databaseURL,
    }).catch(e => console.error('Error publicando dónde vive el espejo público', e));
  }).catch(()=>{});
}
...
function initPublicRequestsListener(){
  ...
  getPublicMirrorApp().then(app => {
    ...
    app.database().ref('gastrogoan/public/' + publicId + '/requests').on('child_added', snap => {
      ...
      reqRef.child('_claimedAt').transaction(current => current === null ? Date.now() : undefined).then(async claimResult => {
      ...
      // hueco (guardado local todavía en curso, solicitud ya borrada de la
      // nube) podía dejar el pedido/reserva sin ningún rastro recuperable —
      // ni local (si el guardado no llegó a completarse) ni remoto (ya
      // borrado). Hallazgo de una auditoría externa.
      await saveDB();
      refreshAfterRemoteChange();
...
function applyRemoteBlock(key, remoteValue){
  ...
  if(LISTAS_DE_NOMBRES.has(key) && Array.isArray(DB[key]) && Array.isArray(merged)){
    ...
    if(key === 'promos'){
      merged = mergePromosUsedDates(DB[key], merged, lastSyncedSnapshot && lastSyncedSnapshot[key]);
    }
    if(key === 'clients'){
      merged = mergeClientCounters(DB[key], merged, lastSyncedSnapshot && lastSyncedSnapshot[key]);
    }
  }
...
function mergeRemoteIntoLocal(val){
  ...
  const newSnapshot = {};
  // Las lápidas de la nube tienen que estar puestas ANTES de limpiar
  // ARRAYS_CON_LAPIDA, no cuando le toque el turno a la clave 'borrados' en
  // Object.keys() (que puede caer después de recipes/employees/etc.): si no,
  // los primeros arrays de esta misma carga se limpiaban con las lápidas
  // VIEJAS, sin las que acababan de llegar de la nube, y algo borrado en otro
  // dispositivo podía resucitar un instante en la carga inicial completa
  // (applyRemoteBlock, para los listeners incrementales, no tiene este
  // problema porque solo procesa un bloque cada vez).
  if(merged.borrados !== undefined) DB.borrados = mergeLapidas(DB.borrados, merged.borrados);
  Object.keys(merged).forEach(key => {
    ...
    if(MERGEABLE_ARRAYS.has(key) && Array.isArray(DB[key]) && Array.isArray(value)){
      ...
      if(key === 'promos'){
        value = mergePromosUsedDates(DB[key], value, lastSyncedSnapshot && lastSyncedSnapshot[key]);
      }
      if(key === 'clients'){
        value = mergeClientCounters(DB[key], value, lastSyncedSnapshot && lastSyncedSnapshot[key]);
      }
    ...
    // Mismo tratamiento que en applyRemoteBlock: sin esto, la carga inicial
    // completa (al abrir la app) sustituía el cuaderno de I+D entero por el
    // de la nube, perdiendo una prueba lanzada en este dispositivo que aún
    // no se había subido, y una respuesta que llegara mientras el cocinero
    // seguía hablando con el asistente desaparecía del hilo. Hallazgo de una
    // auditoría externa: faltaba solo aquí, en el arranque.
    if(key === 'idr' && DB[key] && typeof value === 'object'){
      value = mergeNestedArraysByKey(DB[key], value, ['creaciones','carpetas']);
      if(Array.isArray(value.creaciones) && Array.isArray(DB[key].creaciones)){
        const locales = new Map(DB[key].creaciones.map(c => [c && c.id, c]));
        value.creaciones = value.creaciones.map(c => {
          const local = c && locales.get(c.id);
          return local ? fusionarCreacionIdr(local, c) : c;
        });
      }

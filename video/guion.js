...
export const GUION = [
  ...
  {ir: () => navigate('ingredientes'), titulo: 'Tus ingredientes, con el precio real de tu proveedor', seg: 5},
  ...
  {ir: () => navigate('empleados'), titulo: 'Personal — turnos, fichajes y nóminas', seg: 5},
  {ir: () => navigate('ge'), titulo: 'Gestión económica — costes fijos y rentabilidad', seg: 5},
